...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Host       = 'http://localhost/tstema/';  // SEU HOST (HOSPEDAGEM)
    $mail->SMTPAuth   = true;                        // Manter em true
    $mail->Username   = 'talitasoarests@outlook.com';   //SEU USUÁRIO DE EMAIL
    $mail->Password   = 'miguel13';                   //SUA SENHA DO EMAIL SMTP password
    ...
    //Recipients
    $mail->setFrom('talitasoarests@outlook.com', 'Site');  //DEVE SER O MESMO EMAIL DO USERNAME
    $mail->addAddress('talitasoarests@outlook.com');     // QUAL EMAIL RECEBERÁ A MENSAGEM!
    ...
    $mail->Subject = 'Promoção Marias Kids'; //ASSUNTO
